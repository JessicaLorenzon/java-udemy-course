...
public class Program {
	...
	public static void main(String[] args) {
		...
		LocalDate d04 = LocalDate.parse("2025-01-16");
		LocalDateTime d05 = LocalDateTime.parse("2025-01-16T01:30:26");
		Instant d06 = Instant.parse("2025-01-16T01:30:26Z");
		Instant d07 = Instant.parse("2025-01-16T01:30:26-03:00");

		// https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/format/DateTimeFormatter.html
		LocalDate d08 = LocalDate.parse("16/01/2025", fmt1);
		LocalDateTime d09 = LocalDateTime.parse("16/01/2025 01:30", fmt2);

		LocalDate d10 = LocalDate.of(2025, 01, 16);
		LocalDateTime d11 = LocalDateTime.of(2025, 01, 16, 1, 30);
